...
class AcGameObject {
    constructor() {
        ...
        this.has_caller_start = false;  // 是否执行过start函数
    ...
    create_uuid() {
        let res = "";
        for (let i = 0; i < 8; i ++) {
            let x = parseInt(Math.floor(Math.random() * 10)); // Mathi.random()返回[0, 1)之间的数
            res += x;
        }
        return res;
    }
...
class MultiPlayerSocket {
    constructor(playground) {
        ...
        this.ws = new WebSocket("wss://app6805.acapp.acwing.com.cn/wss/multiplayer/");
...
`<div class="ac-game-settings">
    <div class="ac-game-settings-login">
        ...
        <div class="ac-game-settings-acwing">
            <img width="30" src="https://app6805.acapp.acwing.com.cn/static/image/settings/acwing_logo.png">
            <br>
            <div>
                AcWing一键登录
            </div>
...
`);
    ...
    acwing_login() {
        $.ajax({
            url: "https://app6805.acapp.acwing.com.cn/settings/acwing/web/apply_code/",
            type: "GET",
    ...
    login_on_remote() {
        ...
        $.ajax({
            url: "https://app6805.acapp.acwing.com.cn/settings/login/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    register_on_remote() {
        ...
        $.ajax({
            url: "https://app6805.acapp.acwing.com.cn/settings/register/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    logout_on_remote() {
        if (this.platform === "ACAPP") {
            ...
            $.ajax({
                url: "https://app6805.acapp.acwing.com.cn/settings/logout/",
                type: "GET",
                success: function(resp) {
                    if (resp.result === "success") {
                        location.reload();
    ...
    getinfo_acapp() {
        ...
        $.ajax({
            url: "https://app6805.acapp.acwing.com.cn/settings/acwing/acapp/apply_code/",
            type: "GET",
            success: function(resp) {
                if (resp.result === "success") {
    ...
    getinfo_web() {
        ...
        $.ajax({
            url: "https://app6805.acapp.acwing.com.cn/settings/getinfo/",
            type: "GET",
            data: {
